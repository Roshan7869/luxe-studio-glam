...
class GlamLux_Repo_Membership {
	...
	public function has_purchase_for_order($cid, $mid, $oid) { global $wpdb; return (int)$wpdb->get_var($wpdb->prepare("SELECT COUNT(*) FROM {$wpdb->prefix}gl_membership_purchases WHERE client_id=%d AND membership_id=%d AND wc_order_id=%d", $cid, $mid, $oid)) > 0; }
