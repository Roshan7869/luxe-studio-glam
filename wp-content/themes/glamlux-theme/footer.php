...
?>
        <div>
            <h4 style="font-size:0.6875rem;font-weight:600;letter-spacing:0.12em;text-transform:uppercase;color:rgba(255,255,255,0.3);margin-bottom:20px;"><?php echo esc_html($group_title); ?></h4>
...
endforeach; ?>
    ...
    <div style="border-top:1px solid rgba(255,255,255,0.06);padding-top:28px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:16px;">
        <span style="font-size:0.8125rem;color:rgba(255,255,255,0.25);">&copy; <?php echo date('Y'); ?> GlamLux2Lux. All rights reserved.</span>
        <div style="display:flex;gap:24px;">
            <?php foreach (array('Privacy Policy', 'Terms', 'GDPR') as $p): ?>
            <a href="#" style="font-size:0.8125rem;color:rgba(255,255,255,0.25);text-decoration:none;transition:color 180ms ease;"
               onmouseover="this.style.color='rgba(255,255,255,0.55)'" onmouseout="this.style.color='rgba(255,255,255,0.25)'"><?php echo esc_html($p); ?></a>
            <?php
endforeach; ?>
        </div>
    </div>
